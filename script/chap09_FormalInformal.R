...
# (2) 텍스트 자료 가져오기
facebook <- file("C:/workspace/bigdata/R/data/facebook_bigdata.txt",encoding = "UTF-8")
facebook
...
# 데이터 불러오기
txt <- readLines("C:/workspace/bigdata/R/data/hiphop.txt")
head(txt)
...
# 1. 텍스트 파일 가져오기
marketing <- file("C:/workspace/bigdata/R/data/marketing.txt", encoding = "UTF-8")
marketing
