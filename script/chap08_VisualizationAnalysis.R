...
# 가장 최근 그래프 저장
ggsave(file="C:/workspace/bigdata/R/output/diamond_price.pdf")
ggsave(file="C:/workspace/bigdata/R/output/diamond_price.jpg", dpi=72)
...
ggsave(file="C:/workspace/bigdata/R/output/diamond_price.png",plot=p,width=10, height=5)
